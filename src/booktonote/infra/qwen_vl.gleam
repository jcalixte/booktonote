/// Qwen2-VL OCR implementation for text extraction
...
/// Default path to the OCR worker script (local development)
const default_ocr_worker_path = "./scripts/ocr_worker.py"
...
/// Check if Qwen2-VL is installed by checking if worker can start
...
/// Extract text from an image using the persistent Qwen2-VL worker
